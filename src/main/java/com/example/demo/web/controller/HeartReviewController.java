...
public class HeartReviewController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "에러", content = @Content(schema = @Schema(implementation = String.class)))})
    public ResponseEntity<Long> saveHeartReview(@RequestBody Long reviewId, @AuthenticationPrincipal Long userId) throws IllegalAccessException {
        return new ResponseEntity<>(heartReviewService.save(userId, reviewId), HttpStatus.OK);
    }
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "에러", content = @Content(schema = @Schema(implementation = String.class)))})
    public ResponseEntity<Long> deleteHeartReview(@PathVariable("reviewId") Long reviewId, @AuthenticationPrincipal Long userId) throws IllegalAccessException {
